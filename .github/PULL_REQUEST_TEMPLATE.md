<!-- Thanks for contributing to Geode! -->
...
- [ ] New color / token mapping
- [ ] Contrast or accessibility fix
- [ ] Documentation
- [ ] Other
...
<!-- Optional: screenshots or a short code snippet showing the difference. -->
